...
function TicTacToe() {
  ...
  function goHome() {
    ...
    const reset = ()=>{
        ...
        titleRef.current.innerHTML=`<h2>TicTacToe 3x3 Game</h2>`;
  ...
  return (
    <div>
        <div className="title" ref={titleRef}> <h2>TicTacToe 3x3 Game</h2></div>
        <div className="board">
            <div className="row1">
      ...
      <button onClick={goHome}>Bcak to HomePage</button>
    </div>
  );
}
